...
| Hash | Message |
|------|---------|
| 55faae9 | Initial commit |
| a560213 | chore: Phase 0 - project setup complete |
| 22946de | feat: Phase 1 - Authentication with magic link |
| 907465d | docs: Update session log with Phase 1 progress |
| 8230e45 | feat: Phase 2 - Onboarding with boat creation and crew invites |
| 8eec13f | fix: Resolve navigation error on app startup |
| ef67aba | docs: Update session log with Phase 2 progress |
| bcb6828 | fix: Add 5-second timeout fallback for auth initialization |
| a19cc60 | fix: Resolve app stuck on loading screen |
| f67a260 | fix: Restructure auth navigation to prevent mount errors |
| 2a9f8a6 | feat: Add dev login bypass for testing |
